...
* [Report issues](#bugs-and-feature-requests). If you encounter a bug, an inaccuracy in or lack of documentation or just want to request a feature, create an issue to let us know. We will get back to you as soon as possible.
...
Please create an issue _before_ you start implementing - the subsequent discussion might influence your implementation significantly. This goes for both features and bugfixes.
