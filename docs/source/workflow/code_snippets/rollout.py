...
sequential = SequentialRolloutRunner(
    n_episodes=10, max_episode_steps=100, record_trajectory=True, record_event_logs=True, render=True
)
sequential.run_with(
    env=env, wrappers={'maze.core.wrappers.reward_scaling_wrapper.RewardScalingWrapper': {'scale': 0.1}}, agent=agent
)
