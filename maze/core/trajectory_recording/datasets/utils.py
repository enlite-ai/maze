...
def retrieve_done_and_last_info(trajectory: TrajectoryRecord) -> Tuple[bool, bool, Dict]:
...
def retrieve_episode_end_info(trajectory: TrajectoryRecord) -> Tuple[bool, bool, Dict]:
    ...
    """
    is_terminated, is_truncated, info = retrieve_done_and_last_info(trajectory)
