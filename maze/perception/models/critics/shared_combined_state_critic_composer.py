...
from maze.core.agent.torch_state_critic import TorchSharedStateCritic, TorchSharedCombinedStateCritic
from maze.core.annotations import override
from maze.core.env.structured_env import StepKeyType
from maze.core.utils.factory import Factory, ConfigType
from maze.core.utils.structured_env_utils import flat_structured_shapes, prefixed_structured_shapes
from maze.perception.models.critics.base_state_critic_composer import BaseStateCriticComposer


class SharedCombinedStateCriticComposer(BaseStateCriticComposer):
    """One critic is shared across all sub-steps or actors.

    Instantiates a
    :class:`~maze.core.agent.torch_state_critic.TorchSharedCombinedStateCritic`.
    ...
    def __init__(self,
        ...
        obs_shapes_flat = prefixed_structured_shapes(self._obs_shapes, self._agent_counts_dict)
    ...
    def critic(self) -> TorchSharedStateCritic:
        ...
        """
        return TorchSharedCombinedStateCritic(self._critics, num_policies=len(self._obs_shapes), device="cpu")
