...
class DummyPolicyNet(DummyBaseNet):
    ...
    def __init__(
        ...
        for action_head_name in action_logits_shapes.keys():
            head_hidden_units = [
                lambda out_shape: out_shape[0] * 5,
            ...
            self.perception_dict[f'{action_head_name}_net'] = DenseBlock(
                ...
                out_keys=f'{action_head_name}_net',
                hidden_units=head_hidden_units[:-1],
                non_lin=non_lin,
            )
            ...
            self.perception_dict[f'{action_head_name}'] = LinearOutputBlock(
                ...
                out_keys=action_head_name,
                output_units=head_hidden_units[-1],
            )
