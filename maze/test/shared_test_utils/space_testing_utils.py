...
def build_dict_obs_space():
    ...
    space_dict["categorical_feature"] = gym.spaces.Box(low=0, high=11, shape=(), dtype=int)
    space_dict["categorical_feature_series"] = gym.spaces.Box(low=0, high=11, shape=(64,), dtype=int)
