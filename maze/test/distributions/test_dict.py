...
def get_dict_distribution():
    ...
    distribution_dict = {
        'action_0': CategoricalProbabilityDistribution(
            logits=logits_0, action_space=spaces.Discrete(9), temperature=1.0
        ),
        'action_1': BernoulliProbabilityDistribution(
            logits=logits_1, action_space=spaces.MultiBinary(5), temperature=1.0
        ),
    }
