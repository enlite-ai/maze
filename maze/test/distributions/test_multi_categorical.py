...
def test_multi_categorical_sample():
    ...
    dist = MultiCategoricalProbabilityDistribution(
        logits=logits, action_space=spaces.MultiDiscrete((3, 5)), temperature=1.0
    )
...
def test_multi_categorical_kl():
    ...
    dist_0 = MultiCategoricalProbabilityDistribution(
        logits=logits_0, action_space=spaces.MultiDiscrete((3, 5)), temperature=1.0
    )
    dist_1 = MultiCategoricalProbabilityDistribution(
        logits=logits_1, action_space=spaces.MultiDiscrete((3, 5)), temperature=1.0
    )
