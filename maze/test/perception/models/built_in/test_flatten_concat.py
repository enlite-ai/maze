...
def test_model():
    ...
    obs_space = spaces.Dict(
        spaces={'obs_1': spaces.Box(low=0, high=1, shape=(20, 10)), 'obs_2': spaces.Box(low=0, high=1, shape=(20,))}
    )

    obs_shapes = {'obs_1': (20, 10), 'obs_2': (20,)}
    action_logits_shapes = {'act_1': (5,), 'act_2': (10,)}

    policy_net = FlattenConcatPolicyNet(
        obs_shapes=obs_shapes, action_logits_shapes=action_logits_shapes, hidden_units=[32, 32], non_lin=torch.nn.ReLU
    )
