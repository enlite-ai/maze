...
def test_attention_1d():
    ...
    self_attn_block = MultiHeadAttentionBlock(
        in_keys=['in_key_0', 'in_key_1', 'in_key_2'],
        out_keys=['added_attention', 'attention'],
        in_shapes=[(10,), (10,), (10,)],
        num_heads=10,
        dropout=0.0,
        bias=False,
...
def test_attention_sequential_masked():
    ...
    self_attn_block = MultiHeadAttentionBlock(
        in_keys=['in_key_0', 'in_key_1', 'in_key_2', 'in_key_3'],
        out_keys='self_attention',
        in_shapes=[(7, 10), (7, 10), (7, 10), (7, 7)],
        num_heads=10,
        dropout=0.0,
        bias=False,
        add_input_to_output=True,
