...
def run_gnn_config(
    ...
    for d0, d1 in [
        ([n_nodes, n_node_features], [n_edges, n_edge_features]),
...
def test_gnn_block():
    ...
    run_gnn_config(
        ...
        with_edge_embedding=True,
    )
    run_gnn_config(
        node2node_aggr=True,
        edge2node_aggr=False,
        node2edge_aggr=False,
        edge2edge_aggr=True,
        with_node_embedding=True,
        with_edge_embedding=True,
    )
    ...
    run_gnn_config(
        ...
        edge2node_aggr=False,
        node2edge_aggr=False,
        edge2edge_aggr=False,
        with_node_embedding=True,
        with_edge_embedding=False,
    )
    run_gnn_config(
        node2node_aggr=True,
        edge2node_aggr=True,
