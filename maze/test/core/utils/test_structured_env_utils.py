...
from maze.core.utils.structured_env_utils import flat_structured_shapes, flat_structured_space, stacked_shapes
...
def test_flat_structured_space_and_shapes():
    """unit tests"""
    structured_space_dict = {}
    structured_space_dict[0] = spaces.Dict(spaces={'discrete': spaces.Discrete(5), 'binary': spaces.MultiBinary(5)})
...
def test_stacked_shapes():
    ...
    shapes = {0: dict(a=(1,), b=(1, 2)), 1: dict(c=(1,), d=(2, 2))}
    expected_stacked_shapes = {0: dict(a=(1,), b=(1, 2)), 1: dict(c=(3, 1), d=(3, 2, 2))}
