...
def test_pre_processing_wrapper():
    ...
    for key in ['observation_0_feature_series', 'observation_0_feature_series-flatten']:
...
def test_preprocessing_init_from_yaml_config():
    ...
    for key in ['observation_0_feature_series', 'observation_0_feature_series-dummy']:
        assert key in observation_keys
        assert obs[key] in env.observation_spaces_dict[0][key]
    ...
    config = {
        'pre_processor_mapping': [
            ...
            },
            {
                ...
                '_target_': 'maze.core.wrappers.observation_preprocessing.preprocessors.resize_img.'
