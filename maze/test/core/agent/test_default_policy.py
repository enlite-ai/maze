...
class DummyFlatPolicy(FlatPolicy):
    ...
    def compute_action(self, observation: ObservationType, deterministic: bool) -> ActionType:  # noqa: ARG002
        """compute action"""
...
def test_default_policy():
    """unit tests"""
    default_policy = DefaultPolicy({'policy_0': DummyFlatPolicy('action_0'), 'policy_1': DummyFlatPolicy('action_1')})
