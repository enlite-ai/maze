...
class SelectionValueNet(nn.Module):
    ...
    def __init__(self, obs_shapes: dict[str, Sequence[int]], non_lin: str | type(nn.Module)):
        ...
        self.perception_dict['inventory_feat'] = DenseBlock(
            in_keys='inventory-flatten',
            out_keys='inventory_feat',
            in_shapes=self.obs_shapes['inventory-flatten'],
        ...
        self.perception_dict['latent'] = ConcatenationBlock(
            in_keys=['inventory_feat', 'order_feat'],
            out_keys='latent',
...
class CuttingValueNet(nn.Module):
    ...
    def __init__(self, obs_shapes: dict[str, Sequence[int]], non_lin: str | type(nn.Module)):
        ...
        self.perception_dict['latent'] = ConcatenationBlock(
            in_keys=['order_feat', 'selected_feat'],
            out_keys='latent',
            in_shapes=[[hidden_units], [hidden_units], [hidden_units]],
            concat_dim=-1,
        )
