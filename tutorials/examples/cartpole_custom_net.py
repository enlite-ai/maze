...
class PolicyNet(nn.Module):
    ...
    def __init__(self, obs_shapes, action_logits_shapes, non_lin=nn.Tanh):
        ...
        self.perception_network = DenseBlock(
            in_keys='observation',
            out_keys='latent',
        ...
        # build action head
        self.action_head = LinearOutputBlock(
            in_keys='latent',
            out_keys='action',
        ...
        self.net = InferenceBlock(
            ...
            perception_blocks={'latent': self.perception_network, 'action': self.action_head},
        )
...
class ValueNet(nn.Module):
    ...
    def __init__(self, obs_shapes, non_lin=nn.Tanh):
        ...
        # build action head
        self.value_head = LinearOutputBlock(
            in_keys='latent', out_keys='value', in_shapes=self.perception_network.out_shapes(), output_units=1
        )
        ...
        self.net = InferenceBlock(
            ...
            out_keys='value',
            in_shapes=list(obs_shapes.values()),
            perception_blocks={'latent': self.perception_network, 'value': self.value_head},
        )
